...
*   **Diet AI**: Added an AI-based diet recommendation endpoint (`GET /api/diet/summary`) which requires users to complete `weight` (kg) and `height` (cm) in the workout profile to produce calorie and macro recommendations (kcal and grams).
